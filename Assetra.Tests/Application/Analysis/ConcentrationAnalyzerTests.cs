...
public class ConcentrationAnalyzerTests
{
    ...
    private sealed class FakePortfolioRepo : IPortfolioRepository
    {
        ...
        public Task<Guid> FindOrCreatePortfolioEntryAsync(string symbol, string exchange, string? displayName, AssetType assetType, string? currency = null, bool isEtf = false, Guid? portfolioGroupId = null, CancellationToken ct = default) => Task.FromResult(Guid.Empty);
