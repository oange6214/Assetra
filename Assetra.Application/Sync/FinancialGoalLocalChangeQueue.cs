...
/// <summary>
/// Adapter wrapping <see cref="IFinancialGoalSyncStore"/> as an
/// <see cref="ILocalChangeQueue"/> so the composite router can dispatch by
/// <c>EntityType = "FinancialGoal"</c>. Mirrors <see cref="AssetLocalChangeQueue"/>.
/// </summary>
public sealed class FinancialGoalLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IFinancialGoalSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public FinancialGoalLocalChangeQueue(IFinancialGoalSyncStore store)
    {
