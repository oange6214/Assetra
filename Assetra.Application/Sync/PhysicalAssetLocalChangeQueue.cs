...
/// <summary>
/// 把 <see cref="IPhysicalAssetSyncStore"/> 包成 <see cref="ILocalChangeQueue"/>。
/// </summary>
public sealed class PhysicalAssetLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IPhysicalAssetSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public PhysicalAssetLocalChangeQueue(IPhysicalAssetSyncStore store)
    {
