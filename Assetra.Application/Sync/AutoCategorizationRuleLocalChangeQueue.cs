...
/// <summary>
/// AutoCategorizationRule 的 <see cref="ILocalChangeQueue"/> 介接（v0.20.11）。
/// 委派 <see cref="IAutoCategorizationRuleSyncStore"/>；manual conflicts 暫存於記憶體，由
/// <see cref="DrainManualConflicts"/> 提供 UI 拉取。
/// </summary>
public sealed class AutoCategorizationRuleLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IAutoCategorizationRuleSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public AutoCategorizationRuleLocalChangeQueue(IAutoCategorizationRuleSyncStore store)
    {
