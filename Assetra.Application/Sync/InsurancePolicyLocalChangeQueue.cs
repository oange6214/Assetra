...
/// <summary>
/// 把 <see cref="IInsurancePolicySyncStore"/> 包成 <see cref="ILocalChangeQueue"/>，
/// 與 <see cref="AssetLocalChangeQueue"/> 對稱。
/// </summary>
public sealed class InsurancePolicyLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IInsurancePolicySyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public InsurancePolicyLocalChangeQueue(IInsurancePolicySyncStore store)
    {
