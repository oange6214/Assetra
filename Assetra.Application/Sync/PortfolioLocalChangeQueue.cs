...
/// <summary>
/// 把 <see cref="IPortfolioSyncStore"/> 包成 <see cref="ILocalChangeQueue"/>，
/// 與 <see cref="AssetLocalChangeQueue"/> 對稱。
/// </summary>
public sealed class PortfolioLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IPortfolioSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public PortfolioLocalChangeQueue(IPortfolioSyncStore store)
    {
