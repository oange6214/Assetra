...
/// <summary>
/// 把 <see cref="IAlertSyncStore"/> 包成 <see cref="ILocalChangeQueue"/>，
/// 與 <see cref="RealEstateLocalChangeQueue"/> 對稱。
/// </summary>
public sealed class AlertLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IAlertSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public AlertLocalChangeQueue(IAlertSyncStore store)
    {
