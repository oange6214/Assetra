...
/// <summary>
/// 把 <see cref="IRetirementAccountSyncStore"/> 包成 <see cref="ILocalChangeQueue"/>。
/// </summary>
public sealed class RetirementAccountLocalChangeQueue : ILocalChangeQueue, IManualConflictDrain
{
    private readonly IRetirementAccountSyncStore _store;
    private readonly object _lock = new();
    private readonly List<SyncConflict> _manual = new();

    public RetirementAccountLocalChangeQueue(IRetirementAccountSyncStore store)
    {
