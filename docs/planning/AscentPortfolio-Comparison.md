...
| P4.5 | ⏳ 獨立 sprint | Inline 價格圖（LiveCharts + 5D/1MO/6MO/1Y/5Y/MAX timeline + 價格/市值 toggle）。預估 1-2 天，需要把 `IStockHistoryProvider` 拉到 asset-level 並整合 LiveChartsCore 跟既有 PortfolioHistoryViewModel 同套。最小可上里程碑（P4.1+P4.2）已完成，加上 P4.3-P4.4 視覺重排，panel 資訊深度 + 結構都到位；P4.5 wow-factor widget 留作獨立任務待 user 觸發 |
