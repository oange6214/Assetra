...
**Baseline:** master release-readiness · 1216 / 1216 tests passing (Release, 2026-05-09 docs sweep)
...
| **美股 (US equities) 支援 — Twelve Data + Nasdaq Symbol Directory** | 4–5 週（權威 plan: `Assetra-US-Market-Data-Plan.md`；`US-Equities-Support-Plan.md` 僅作詳細 appendix） |
