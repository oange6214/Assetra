...
## 13. Multi-Asset Context  *(✅ 已 ship — v0.22.0)*

> 不動產、保險、退休專戶、實物資產四類資產，各有獨立生命週期與估值邏輯，不併入 Portfolio Context。

### 13a. RealEstate Context  *(✅ v0.22.0)*
...
### 13c. RetirementAccount Context  *(✅ v0.22.0)*
...
- → `Analysis`：`FireCalculator`（v0.22.0）讀取退休專戶餘額

---

### 13d. PhysicalAsset Context  *(✅ v0.22.0)*
...
### 14b. Monte Carlo Context  *(✅ v0.22.0)*
...
- `RealEstate`（v0.22.0）
- `Insurance`（v0.22.0）
- `RetirementAccount`（v0.22.0）
- `PhysicalAsset`（v0.22.0）
- `Simulation / FIRE`（v0.22.0）
- `Simulation / MonteCarlo`（v0.22.0）
