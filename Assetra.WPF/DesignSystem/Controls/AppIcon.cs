...
public sealed class AppIcon : Control
{
    ...
    private static IReadOnlyDictionary<string, Geometry> CreateIcons()
    {
        ...
        return new Dictionary<string, Geometry>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Two overlapping rectangle outlines — Windows 11 restore-down icon.
            // Front rect (4,8)-(16,20) outline + back rect (8,4)-(20,16) outline.
            ["WindowMultiple24"] = Icon("M4 8 H16 V20 H4 Z M5 9 V19 H15 V9 Z M8 4 H20 V16 H8 Z M9 5 V15 H19 V5 Z"),
