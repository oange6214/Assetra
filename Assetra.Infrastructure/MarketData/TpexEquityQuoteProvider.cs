...
internal sealed class TpexEquityQuoteProvider(ITpexClient client) : IEquityQuoteProvider
{
    public string ProviderName => "TPEX";
        ...
        CancellationToken ct = default)
    {
        ...
        return keys.Select(k =>
            ...
            ?? LegacyStockQuoteMapper.MissingQuote(k, ProviderName, $"TPEX did not return quote for {k.Symbol}."))
            .ToList();
    }
}
